  ...
  const accessData = () => {
    AsyncStorage.getItem('BranchID').then(
      keyValue => {
        ...
        fetch(`${GLOBALS.TEACHER_URL}GetTeachersDetailsComplete`, {
          method: 'POST',
          body: `<?xml version="1.0" encoding="utf-8"?>
          <soap12:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap12="http://www.w3.org/2003/05/soap-envelope">
            <soap12:Body>
              <GetTeachersDetailsComplete xmlns="http://www.m2hinfotech.com//">
                <teacherId>${value}</teacherId>
              </GetTeachersDetailsComplete>
            </soap12:Body>
          </soap12:Envelope>
     `,
          headers: {
          ...
          .then(response => {
            ...
            const v = xmlDoc.getElementsByTagName(
              'GetTeachersDetailsCompleteResult',
